...
@interface ___PACKAGENAMEASIDENTIFIER___AudioUnit ()
...
@implementation ___PACKAGENAMEASIDENTIFIER___AudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[___PACKAGENAMEASIDENTIFIER___DSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block ___PACKAGENAMEASIDENTIFIER___DSPKernelAdapter * kernelAdapter = _kernelAdapter;
