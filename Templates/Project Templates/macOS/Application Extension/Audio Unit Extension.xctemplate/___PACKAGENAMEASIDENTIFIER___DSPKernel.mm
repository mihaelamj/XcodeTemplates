...
#import "___PACKAGENAMEASIDENTIFIER___DSPKernel.hpp"
#import "___PACKAGENAMEASIDENTIFIER___DSPKernelAdapter.h"

@implementation ___PACKAGENAMEASIDENTIFIER___DSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    ___PACKAGENAMEASIDENTIFIER___DSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block ___PACKAGENAMEASIDENTIFIER___DSPKernel *state = &_kernel;
